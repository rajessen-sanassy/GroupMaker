...
var input_textarea4 = document.querySelector('.names4');
...
//AUTO SAVE
var checked4 = JSON.parse(localStorage.getItem("myonoffswitch4"));
document.getElementById("myonoffswitch4").checked = checked4;

$('.onoffswitch4').on('click', function(e) {
...
$('.clear').on('click', function() {
    var clear = document.querySelector('.names4');
...
$('.append').on('click', function(e) {
  ...
  input_textarea4.textContent = localStorage.getItem('students4');


function updateOutput() {
  localStorage.setItem('students4', input_textarea4.textContent);
}
