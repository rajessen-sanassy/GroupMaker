...
var input_textarea3 = document.querySelector('.names3');
...
var checked3 = JSON.parse(localStorage.getItem("myonoffswitch3"));
document.getElementById("myonoffswitch3").checked = checked3;

$('.onoffswitch3').on('click', function(e) {
    var checkbox = document.getElementById("myonoffswitch3");
    localStorage.setItem("myonoffswitch3", checkbox.checked);
  });


$('.clear').on('click', function() {
    var clear = document.querySelector('.names3');
...
$('.append').on('click', function(e) {
  ...
  input_textarea3.textContent = localStorage.getItem('students3');


function updateOutput() {
  localStorage.setItem('students3', input_textarea3.textContent);
}
